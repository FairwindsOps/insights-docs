...
The report can also be downloaded as a PDF at any time.
...
### Bug Fixes
* The Slack **Notifications** page will now show which Slack channels are used for a cluster's notifications once a cluster has been chosen
